...
public class TokenMessageArgument {
	...
	public TokenMessageArgument(){
		sentCl=new ArrayList<IndepClause>();
		direction=1;
		currentFlags=new HashSet<CanalComm>();
		nextFlags=new HashSet<CanalComm>();
	}
	
	public TokenMessageArgument(Collection<IndepClause> clauses, int dir, HashSet<CanalComm> curr, HashSet<CanalComm> next){
		sentCl=clauses;
		direction=dir;
		currentFlags=curr;
		nextFlags=next;
	...
	public Collection<IndepClause> getSentCl() {
		return sentCl;
	}
	...
	protected Collection<IndepClause> sentCl;
